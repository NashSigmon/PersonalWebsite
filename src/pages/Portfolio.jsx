function Portfolio() {
    return (
        <div>
            ...
            <section class="port_section" id="Portfolio1">
            ...
            <section class="port_section" id="Portfolio2">
                ...
                <ul>
                    <li>Preformed Vulnerability Scanning using Nmap and diagnosed 4+ vulnerabilities
                        across Production and web servers</li>
                    <li>Exploited 2+ Vulnerabilities using Metasploit to gain root acess and validate
                        security risks
                    </li>
                     <li>Established presistance via backdoor account creation and conducted password cracking using
                        John The Ripper
                    </li>
                </ul>
            </section>
            <section class="port_section" id="Portfolio3">
